...
__all__ = [ 'IFontDisp', 'IFont', 'OLE_YSIZE_PIXELS', 'Picture',
           'IPicture', 'FONTBOLD', 'Color', 'OLE_XSIZE_HIMETRIC',
           'OLE_XPOS_HIMETRIC', 'OLE_YPOS_CONTAINER',
           'OLE_OPTEXCLUSIVE', 'Checked', 'OLE_YSIZE_HIMETRIC',
           'OLE_XPOS_CONTAINER', 'FONTSIZE', 'OLE_XPOS_PIXELS',
           'OLE_XSIZE_PIXELS', 'Default', 'OLE_XSIZE_CONTAINER',
           'VgaColor', 'Font', 'IFontEventsDisp', 'IPictureDisp',
           'Gray', 'OLE_YPOS_PIXELS', 'Monochrome', 'FONTITALIC',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_HANDLE',
           'OLE_YSIZE_CONTAINER', 'OLE_TRISTATE', 'OLE_CANCELBOOL',
           'FONTNAME', 'StdFont', 'FONTSTRIKETHROUGH', 'StdPicture',
           'OLE_YPOS_HIMETRIC', 'Unchecked', 'FONTUNDERSCORE',
           'OLE_COLOR', 'LoadPictureConstants', 'FontEvents']
from comtypes import _check_version; _check_version('1.1.11', 1711956124.7159297)
